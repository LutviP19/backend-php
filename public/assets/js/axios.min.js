...
function getCookieByName(t){const e=t+"=",n=document.cookie.split(";");for(let t=0;t<n.length;t++){let l=n[t];for(;" "===l.charAt(0);)l=l.substring(1,l.length);if(0===l.indexOf(e))return l.substring(e.length,l.length)}return null}
axios.defaults.headers.post['Accept'] = 'application/json';
axios.defaults.headers.post['X_CSRF_TOKEN'] = (document.getElementById("csrf_token")?.value ?? getCookieByName('XSRF-TOKEN')).trim();
axios.defaults.headers.post['X-Api-Token'] = 'eyJpdiI6Im9Nbm5STk9FYWhhTE12SEhKT2pNanc9PSIsInZhbHVlIjoiUGRSQ0g5cCtKTEU2NGd5MDVJa3J1WDJkUTBML3I1cG94TDVxeHBOaEpOWT0iLCJtYWMiOiIwYWU1NWNlOTllZGMxZDFjYmJhZTE2MzgyMmNiNzYzNjEzYjY3Yjc0MDFlYjgxYzJiN2VjNzk1ZDIzNTNhYTNkIiwidGFnIjoiIn0=';